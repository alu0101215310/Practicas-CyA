...
////////////////////////////////////////////////////////////////////////////////
// Archivo regex.cc: 
//    Fichero que contiene las definición de la clase regex y sus métodos
////////////////////////////////////////////////////////////////////////////////
...
void regex::build (void) {
  ...
  while (getline(inputFile, line)) {
    ...
    else if (std::regex_match(line, std::regex(RETEX))) {
      returnEx ret(line, counter);
...
void regex::write (std::string program) {
  ...
  for (auto it : comments)
    outputFile << it << std::endl;
  outputFile << std::endl << "RETURNS:" << std::endl;
  for (auto it : returns)
    outputFile << it << std::endl;
}